...
public class UIScript : MonoBehaviour {
	...
	public int high, score,dipakai;

	public List<Image> lives = new List<Image>(3);

	Text txt_score, txt_high, txt_level,txt_dipakai;
	...
	void Start () 
	{
        ...
        txt_dipakai = GetComponentsInChildren<Text>()[3];
	...
	void Update () 
	{
        ...
        dipakai = GameManager.dipakai;
		txt_score.text = "Score\n" + score;
        txt_dipakai.text = "Isi Tas\n" + dipakai;
